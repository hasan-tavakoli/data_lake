...
create table dimuser (id String,givenName String,familyName String,email String,gender String,phoneNumber String,dateOfBirth String) stored as parquetfile LOCATION 'hdfs://namenode:9000//EDL_Data/Trusted_Data_Zone/user';MSCK REPAIR TABLE dimuser;
...
create table dimuserlive (id String,givenName String,familyName String,email String,gender String,phoneNumber String,dateOfBirth String) stored as parquetfile LOCATION 'hdfs://namenode:9000//destination/dir';MSCK REPAIR TABLE dimuserlive;
